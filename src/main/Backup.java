...
public class Backup {
	...
	public static void backup() {
		...
		/**
		 * This needs to be run from Eclipse, there's no compiled version
		 * 
		 ...
		 * Use type I if goal is to create a json file from an incremental backup<br>
		 * <br>
		 * sourcesubfolder en destinationsubfolder (if incremental) must be set in the code itself
		 */
        ...
        if (commandLineArguments.fullBackup) {
        	...
        	AFileOrAFolder listOfFilesAndFoldersInDest = createJsonStructure(commandLineArguments, destinationFolderPath, destinationsubfolder);     	
            ...
            String destFolderToJson = fromAFileOrAFolderToJsonString(listOfFilesAndFoldersInDest);
